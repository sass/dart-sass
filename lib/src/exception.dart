...
/// {@category Parsing}
@sealed
class SassFormatException(super.message, super.span, [super.loadedUrls])
    extends SassException
  ...
  MultiSpanSassFormatException withAdditionalSpan(
    FileSpan span,
    String label,
  ) => MultiSpanSassFormatException(message, this.span, "", {
    span: label,
  }, loadedUrls);
...
class SassScriptException(String message, [String? argumentName]) {
  /// The error message.
