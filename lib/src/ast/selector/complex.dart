...
final class ComplexSelector extends Selector {
  ...
  /// @nodoc
  @internal
  bool get isBogusOtherThanLeadingCombinator => switch (components.last) {
        null => leadingCombinator != null,
        var last => last.combinator != null
      };
  ...
  ComplexSelector(Iterable<ComplexSelectorComponent> components, super.span,
      {this.leadingCombinator, this.lineBreak = false})
  ...
  ComplexSelector? prependCombinator(CssValue<Combinator>? combinator) {
    ...
    if (leadingCombinator != null) return null;
    return ComplexSelector(components, span,
        leadingCombinator: combinator, lineBreak: lineBreak);
  }
  ...
  /// @nodoc
  @internal
  ComplexSelector? withAdditionalCombinator(CssValue<Combinator>? combinator,
      ...
      combinator == null
          ...
          : switch (components) {
              [...var initial, var last] => last
                  ...
                  .andThen((newLast) => ComplexSelector(
                      [...initial, newLast], span,
  ...
  ComplexSelector withAdditionalComponent(
      ...
      component == null
          ? this
          : ComplexSelector([...components, component], span,
              leadingCombinator: leadingCombinator,
              lineBreak: lineBreak || forceLineBreak);
  ...
  ComplexSelector? concatenate(ComplexSelector child, FileSpan span,
      ...
      switch (child.leadingCombinator) {
        null => ComplexSelector([...components, ...child.components], span,
            leadingCombinator: leadingCombinator,
        ...
        var childCombinator => switch (components) {
            [...var initial, var last] => last
                ...
                .andThen((newLast) => ComplexSelector(
                    [...initial, newLast, ...child.components], span,
                    leadingCombinator: leadingCombinator,
                    lineBreak: lineBreak || child.lineBreak || forceLineBreak)),
