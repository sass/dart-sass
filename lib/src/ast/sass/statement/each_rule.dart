...
final class EachRule extends ParentStatement<List<Statement>> {
  ...
  EachRule(Iterable<String> variables, this.list, Iterable<Statement> children,
      this.span)
      : variables = List.unmodifiable(variables), afterTrailing = span.end,
        super(List.unmodifiable(children));

  /// :nodoc:
  @internal
  EachRule.internal(Iterable<String> variables, this.list, Iterable<Statement> children,
      this.span, this.afterTrailing)
