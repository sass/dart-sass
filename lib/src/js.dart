...
void main() {
  ...
  exports.Value = JSValue.jsClass;
  exports.SassBoolean = JSSassBoolean.jsClass;
  exports.SassArgumentList = JSSassArgumentList.jsClass;
  exports.SassCalculation = JSSassCalculation.jsClass;
  exports.CalculationOperation = JSCalculationOperation.jsClass;
  exports.CalculationInterpolation = JSCalculationInterpolation.jsClass;
  exports.SassColor = JSSassColor.jsClass;
  exports.SassFunction = JSSassFunction.jsClass;
  exports.SassMixin = JSSassMixin.jsClass;
  exports.SassList = JSSassList.jsClass;
  exports.SassMap = JSSassMap.jsClass;
  exports.SassNumber = JSSassNumber.jsClass;
  exports.SassString = JSSassString.jsClass;
  ...
  exports.Logger = LoggerNamespace(
    silent: JSLogger(
      warn: (_, __) {}.toJS..name = 'sass.Logger.silent.warn',
      debug: (_, __) {}.toJS..name = 'sass.Logger.silent.debug',
    ),
  );
  exports.NodePackageImporter = JSNodePackageImporter.jsClass;
  exports.deprecations = JSDeprecation.all;
  exports.Version = JSVersion.jsClass;
  ...
  JSCanonicalizeContext.updatePrototype();
  JSFileSpan.updatePrototype();
  JSFileLocation.updatePrototype();
