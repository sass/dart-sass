...
@JS('immutable.isList')
external bool _isImmutableList(Object? object);
...
external bool _isImmutableMap(Object? object);
...
extension type ImmutableMap<K extends JSAny?, V extends JSAny?>._(JSObject _)
  ...
  external ImmutableMap<K, V> set(Object key, Object? value);
...
extension ListToImmutableList<E extends JSAny?> on List<E> {
  ...
  ImmutableList<E> get toJSImmutable => ImmutableList(this.toJS);
}
