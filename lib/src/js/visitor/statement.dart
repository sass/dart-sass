...
class JSStatementVisitor implements StatementVisitor<JSAny?> {
  ...
  JSAny? visitEachRule(EachRule node) => _inner.visitEachRule(node.toUnsafeWrapper);
  ...
  JSAny? visitForRule(ForRule node) => _inner.visitForRule(node.toUnsafeWrapper);
  ...
  JSAny? visitUseRule(UseRule node) => _inner.visitUseRule(node.toUnsafeWrapper);
  JSAny? visitVariableDeclaration(VariableDeclaration node) =>
      _inner.visitVariableDeclaration(node.toUnsafeWrapper);
  JSAny? visitWarnRule(WarnRule node) => _inner.visitWarnRule(node.toUnsafeWrapper);
...
extension type JSStatementVisitorObject._(JSObject _) {
  ...
  external JSAny? visitVariableDeclaration(UnsafeDartWrapper<VariableDeclaration> node);
