...
extension type JSExpressionVisitorObject._(JSObject _) implements JSObject {
  ...
  external JSAny? visitBooleanExpression(UnsafeDartWrapper<BooleanExpression> node);
  ...
  external JSAny? visitFunctionExpression(UnsafeDartWrapper<FunctionExpression> node);
  ...
  external JSAny? visitNumberExpression(UnsafeDartWrapper<NumberExpression> node);
  external JSAny? visitParenthesizedExpression(UnsafeDartWrapper<ParenthesizedExpression> node);
  external JSAny? visitSelectorExpression(UnsafeDartWrapper<SelectorExpression> node);
  external JSAny? visitStringExpression(UnsafeDartWrapper<StringExpression> node);
  external JSAny? visitSupportsExpression(UnsafeDartWrapper<SupportsExpression> node);
  external JSAny? visitUnaryOperationExpression(UnsafeDartWrapper<UnaryOperationExpression> node);
  external JSAny? visitValueExpression(UnsafeDartWrapper<ValueExpression> node);
  external JSAny? visitVariableExpression(UnsafeDartWrapper<VariableExpression> node);
}
