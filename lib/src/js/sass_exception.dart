...
extension type JSSassException._wrap(JSError _) implements JSError {
  static final JSClass<JSSassException> jsClass = () {
    ...
    var jsClass =
      ...
      superclassConstructor.callAsFunction(args[1]);
    ...
    jsClass.defineGetters({
      ...
      'span': (JSSassException exception) =>
          exception.dartException.toDartObject.span.toJS,
    });
  ...
  external JSSassException._(
      ExternalDartReference<SassException> dartException, String message);
