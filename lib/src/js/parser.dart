...
void _updateAstPrototypes() {
  ...
  var parameters = ArgumentDeclaration([], bogusSpan);
  getJSClass(parameters)
      .defineGetter('arguments', (ArgumentDeclaration self) => self.arguments);
  var function = FunctionRule('a', parameters, [], bogusSpan);
  getJSClass(function)
      .superclass
      .defineGetter('arguments', (CallableDeclaration self) => self.arguments);

  var arguments = ArgumentInvocation([], {}, bogusSpan);
