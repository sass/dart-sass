...
ParserExports loadParserExports() {
  ...
  return ParserExports(
    ...
    createExpressionVisitor:
        ((JSExpressionVisitorObject inner) => JSExpressionVisitor(inner)).toJS,
    createStatementVisitor:
        ((JSStatementVisitorObject inner) => JSStatementVisitor(inner)).toJS,
    setToJS: ((Set<JSAny?> set) => set.toJS).toJS,
    mapToRecord: ((Map<JSString, JSAny?> map) => map.toJS).toJS,
  );
}
...
void _updateAstPrototypes() {
  JSSourceFile.updatePrototype();
  JSInterpolation.updatePrototype();
  JSStatement.updatePrototype();
  JSExpression.updatePrototype();
  JSIncludeRule.updatePrototype();
  JSContentRule.updatePrototype();
  JSIfExpression.updatePrototype();
  JSInterpolatedFunctionExpression.updatePrototype();
  JSSupportsCondition.updatePrototype();
  JSStringExpression.updatePrototype();
  JSBinaryOperationExpression.updatePrototype();
  JSSupportsExpression.updatePrototype();
  JSLoudComment.updatePrototype();
}
