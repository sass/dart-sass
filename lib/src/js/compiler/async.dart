    ...
    var jsClass = JSClass<JSAsyncCompiler>(
      ...
      (JSAsyncCompiler thisArg, JSSymbol constructionKey) {
        ...
        thisArg.defineProperty(
            'disposed'.toJS, JSPropertyDescriptor.getValue(false.toJS, writable: true));

        thisArg.defineProperty('compilations'.toJS,
            JSPropertyDescriptor.getValue(FutureGroup().toExternalReference as JSAny));
      }.toJS,
    );
