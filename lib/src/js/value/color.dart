  ...
  jsClass.defineMethods({
    ...
    'toGamut': (SassColor self, _ToGamutOptions options) {
      ...
      return _toSpace(
        self,
        options.space,
      ).toGamut(GamutMapMethod.fromName(options.method)).toSpace(originalSpace);
    },
    ...
    'change': (SassColor self, _ConstructionOptions options) {
      ...
      if (self.isLegacy && !spaceSetExplicitly) {
        if (hasProperty(options, 'whiteness') ||
          ...
          space = .hwb;
        } else if (hasProperty(options, 'hue') && self.space == .hwb) {
          space = .hwb;
      ...
      switch (space) {
        case .hsl when spaceSetExplicitly:
        ...
        case .hwb when spaceSetExplicitly:
        ...
        case .rgb when spaceSetExplicitly:
