...
@anonymous
extension type RenderContext.__(JSObject _) implements JSObject {
...
@anonymous
extension type RenderContextOptions.__(JSObject _) implements JSObject {
  ...
  factory RenderContextOptions(RenderOptions options, DateTime start) {
    return RenderContextOptions._(
      file: options.file,
      data: options.data,
      includePaths: ([p.current, ...?options.includePaths?.toDart]).join(isWindows ? ';' : ':'),
...
@anonymous
extension type RenderContextResult.__(JSObject _) implements JSObject {
...
@anonymous
extension type RenderContextResultStats.__(JSObject _) implements JSObject {
