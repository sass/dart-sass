...
@anonymous
extension type JSSassLegacyColor._(JSObject _) implements JSObject {
  ...
  static final jsClass = JSClass<JSSassLegacyColor>(
    ...
    ..defineMethods({
      'getR': ((JSSassLegacyColor self) => self.modernValue.red).toJS,
      'getG': ((JSSassLegacyColor self) => self.modernValue.green).toJS,
      'getB': ((JSSassLegacyColor self) => self.modernValue.blue).toJS,
      'getA': ((JSSassLegacyColor self) => self.modernValue.alpha).toJS,
