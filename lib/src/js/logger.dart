...
extension type JSLogger._(JSObject _) implements JSObject {
  ...
  void Function(String message, WarnOptions options)? get warn => _nullableWarn == null ? null : (message, options) => _warn(message, options);

  @JS('debug')
  external JSFunction? get _nullableDebug;
  @JS('debug')
  external void _debug(String message, DebugOptions options);
  void Function(String message, DebugOptions options)? get debug =>_nullableDebug == null ? null : (message, options) => _debug(message, options);
...
extension type WarnOptions._(JSObject _) implements JSObject {
  ...
  external JSSourceSpan? get span;
...
extension type DebugOptions._(JSObject _) implements JSObject {
  ...
  external factory DebugOptions({required JSSourceSpan span});
}
