...
NodeCompileResult compile(String path, [CompileOptions? options]) {
  ...
  try {
    var sourceMapIncludeSources =
        _parseSourceMapIncludeSources(options?.sourceMapIncludeSources);
...
SourceMapIncludeSources _parseSourceMapIncludeSources(
        Object? sourceMapIncludeSources) =>
    switch (sourceMapIncludeSources) {
      null || false || 'auto' => SourceMapIncludeSources.auto,
