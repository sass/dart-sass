...
extension type JSFunctionExpression._(JSObject _) implements JSObject {
  ...
  static void updatePrototype() {
    FunctionExpression('a', ArgumentList.bogus, bogusSpan).toJS.constructor
      .defineGetter('arguments'.toJS, ((JSFunctionExpression self) => self.toDart.arguments as JSObject).toJS);
  }
