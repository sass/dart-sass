...
extension type JSBinaryOperationExpression._(JSObject _) implements JSObject {
  ...
  static void updatePrototype() {
    BinaryOperationExpression(BinaryOperator.plus, Expression.bogus, Expression.bogus).toJS.constructor
      .defineGetter('span'.toJS, ((JSBinaryOperationExpression self) => self.toDart.span.toJS).toJS);
  }
