...
extension type JSLoudCommentExpression._(JSObject _) implements JSObject {
  ...
  static void updatePrototype() {
    LoudCommentExpression(LoudCommentAnything(Interpolation.bogus)).toJS.constructor
      .defineGetter('span'.toJS, ((JSLoudCommentExpression self) => self.toDart.span.toJS).toJS);
  }
