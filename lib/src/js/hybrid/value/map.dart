...
extension type JSSassMap._(JSObject _) implements JSObject {
  ...
  /// from JS.
  static final JSClass<JSSassMap> jsClass = () {
    var jsClass = JSClass<JSSassMap>(
        'sass.SassMap',
        ((JSSassMap self, [ImmutableMap? contents]) => contents == null
            ? const SassMap.empty()
      ...
      ..defineMethod(
          ...
          (JSSassMap jsSelf, JSAny indexOrKey) {
            ...
            if (indexOrKey.asA<JSNumber>()
                case JSNumber(toDartInt: var index)) {
