...
extension type JSSassString._(JSObject _) implements JSObject {
  ...
  /// from JS.
  static final JSClass<JSString> jsClass = () {
    var jsClass = JSClass<JSString>('sass.SassString', ((JSSassString self, [JSObject? textOrOptions, _ConstructorOptions? options]) =>
        textOrOptions.isA<JSString>()
            ? SassString((textOrOptions as JSString).toDart, quotes: options?.quotes ?? true)
            : SassString.empty(
