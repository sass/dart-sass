...
extension type JSSassColor._(JSObject _) implements JSObject {
  ...
  static final JSClass<JSSassColor> jsClass = () {
    var jsClass = JSClass<JSSassColor>(
        'sass.SassColor',
        (JSColor self, _ConstructionOptions options) {
// If alpha is explicitly null and space is not set, emit a deprecation.
      ...
      ..defineStaticMethods({
        'equals':
            ((JSJSSassColor self, JSAny? other) => self.toDart == other).toJS,
        'hashCode': ((JSJSSassColor self) => self.toDart.hashCode).toJS,
        'toSpace': ((JSJSSassColor self, String space) =>
            self.toSpace(space).toJS).toJS,
      ...
      ..defineGetters({
        ...
        'channelsOrNull': ((JSSassColor self) =>
            self.toDart.channelsOrNull.toJSImmutable).toJS,
...
extension type _ConstructionOptions._(_Channels _) implements _Channels {
  ...
  double? alphaOrDefault(double Function() defaultCallback) =>
      alpha.isUndefined ? defaultCallback() : alpha;
}
