...
extension type JSSassColor._(JSObject _) implements JSObject {
  ...
  static final JSClass<JSSassColor> jsClass = () {
    var jsClass = JSClass<JSSassColor>(
        'sass.SassColor',
        (JSSassColor self, _ConstructionOptions options) {
      ...
      ..defineStaticMethods({
        'equals':
            ((JSSassColor self, JSAny? other) => self.toDart == other).toJS,
        'hashCode': ((JSSassColor self) => self.toDart.hashCode).toJS,
        'toSpace':
            ((JSSassColor self, String space) => self.toSpace(space).toJS).toJS,
        'isInGamut': ((JSSassColor self, [String? space]) =>
            self.toSpace(space).isInGamut).toJS,
        'toGamut': ((JSSassColor self, _ToGamutOptions options) => self
            .toSpace(options.space)
            .toGamut(GamutMapMethod.fromName(options.method))
            .toSpace(self.toDart.space)
            .toJS).toJS,
        'channel': ((JSSassColor self, String channel,
      ...
      ..defineGetters({
        ...
        'channelsOrNull': (JSSassColor self) =>
            self.toDart.channelsOrNull.cast<JSNumber?>().toJSImmutable,
        'channels': (JSSassColor self) =>
            self.toDart.channels.cast<JSNumber>().toJSImmutable,
      });
