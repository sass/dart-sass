...
extension type JSSassNumber._(JSObject _) implements JSObject {
  ...
  /// from JS.
  static final JSClass<JSSassNumber> jsClass = () {
    var jsClass = JSClass<JSSassNumber>(
        'sass.SassNumber',
        (
          JSSassNumber self,
          num value, [
          ...
          if (unitOrOptions.asA<JSString>() case var unit?) {
            return SassNumber(value, unit.toDart);
          }
      ...
      ..defineGetters({
        ...
        'numeratorUnits': (JSSassNumber self) =>
      ...
      ..defineMethods({
        'assertInt': ((JSSassNumber self, [String? name]) =>
            self.toDart.assertInt(name)).toJS,
        'assertInRange': ((JSSassNumber self, num min, num max,
                [String? name]) =>
        ...
        'hasUnit': ((JSSassNumber self, String unit) =>
