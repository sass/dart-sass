...
extension SassFunctionToJS on SassFunction {
  ...
  static final JSClass<UnsafeDartWrapper<SassFunction>> jsClass = () {
    var jsClass = JSClass<UnsafeDartWrapper<SassFunction>>(
        'sass.SassFunction',
        (
          UnsafeDartWrapper<SassFunction> self,
          String signature,
          JSFunction callback,
        ) {
          ...
          return SassFunction(
            Callable(
              ...
              (List<Value> values) => (callback.callAsFunctionVarArgs(
                      null, values.cast<UnsafeDartWrapper<Value>>()) as UnsafeDartWrapper<Value>)
                  .toDart,
            ),
          ).toJS;
        }.toJS);
