...
extension type JSSupportsExpression._(JSObject _) implements JSObject {
  ...
  static void updatePrototype() {
    SupportsExpression(SupportsAnything(Interpolation.bogus, bogusSpan).toJS.constructor
      .defineGetter('span'.toJS, ((JSSupportsExpression self) => self.toDart.span.toJS).toJS);
  }
