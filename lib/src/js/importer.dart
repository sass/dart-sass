...
extension type JSImporter._(JSObject _) implements JSObject {
  ...
  @JS('canonicalize')
  external JSAny? _canonicalize(String url, UnsafeDartWrapper<CanonicalizeContext> context);
  JSAny? Function(String, UnsafeDartWrapper<CanonicalizeContext>)? get canonicalize =>
  ...
  @JS('findFileUrl')
  external JSAny? _findFileUrl(String url, UnsafeDartWrapper<CanonicalizeContext> context);
  JSAny? Function(String, UnsafeDartWrapper<CanonicalizeContext>)? get findFileUrl =>
