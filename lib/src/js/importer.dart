...
import 'hybrid/canonicalize_context.dart';
...
extension type JSImporter._(JSObject _) implements JSObject {
  ...
  @JS('canonicalize')
  external JSAny? _canonicalize(String url, JSCanonicalizeContext context);
  JSAny? Function(String, JSCanonicalizeContext)? get canonicalize =>
  ...
  @JS('findFileUrl')
  external JSAny? _findFileUrl(String url, JSCanonicalizeContext context);
  JSAny? Function(String, JSCanonicalizeContext)? get findFileUrl =>
