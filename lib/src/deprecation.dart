...
enum Deprecation {
  ...
  //
  // Checksum: 6d07dacf8e1e8cf4760f4ff3d8d780569dd7f72b
  ...
  /// Deprecation for functions whose names differ from reserved names only by case are now deprecated. These cannot be invoked normally and will be disallowed in a future release.
  caseInsensitiveFunctionNames('case-insensitive-function-names',
      deprecatedIn: '1.91.0',
      description:
          'Functions whose names differ from reserved names only by case are now deprecated. These cannot be invoked normally and will be disallowed in a future release.'),
