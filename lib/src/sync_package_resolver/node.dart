...
class SyncPackageResolver {
  ...
  /// Returns `null` when using a [packageRoot] for resolution, or when no
  /// package resolution is being used.
  Uri get packageConfigUri => throw new Exception('not implemented for node');
  ...
  /// package resolution is being used.
  Uri get packageRoot => throw new Exception('not implemented for node');
  ...
  String get processArgument => throw new Exception('not implemented for node');
  ...
  /// returns `null`.
  Uri resolveUri(packageUri) => throw new Exception('not implemented for node');
  ...
  Uri packageUriFor(url) => throw new Exception('not implemented for node');
