...
describe('a list expression', () => {
  describe('empty', () => {
    describe('without brackets', () => {
      ...
      describe('with a comma separator', () => {
        ...
        describeNode(
          'constructed manually',
          () => new ListExpression({separator: ',', nodes: []}),
        );

        describeNode('constructed from ExpressionProps', () =>
          utils.fromExpressionProps({separator: ',', nodes: []}),
        );
      });
    });
    ...
    describe('with brackets', () => {
      ...
      describe('with a comma separator', () => {
        ...
        describeNode(
          'constructed manually',
          () => new ListExpression({separator: ',', brackets: true, nodes: []}),
        );
        ...
        function describeNode(
          ...
          describe(description, () => {
            ...
            it('has an element', () => {
              ...
              expect(node.nodes).toHaveStringExpression(0, 'foo');
            });
          });
        }
        ...
        function describeNode(
          ...
          describe(description, () => {
            ...
            it('has an element', () => {
              ...
              expect(node.nodes).toHaveStringExpression(0, 'foo');
              expect(node.nodes).toHaveStringExpression(1, 'bar');
            });
          });
        }
  ...
  describe('every', () => {
    ...
    it('returns false if the callback returns false for any element', () =>
      expect(node.every(element => (element as StringExpression).text.asPlain !== 'bar')).toBe(false));
  });
  ...
  describe('insertAfter', () => {
    ...
    it('inserts a node after the given element', () => {
      ...
      expect(node.nodes).toHaveStringExpression(0, 'foo');
      expect(node.nodes).toHaveStringExpression(1, 'bar');
      expect(node.nodes).toHaveStringExpression(2, 'qux');
      expect(node.nodes).toHaveStringExpression(3, 'baz');
    });

    it('inserts a node at the beginning', () => {
      node.insertAfter(-1, {text: 'qux'});
      expect(node.nodes).toHaveLength(4);
      expect(node.nodes).toHaveStringExpression(0, 'qux');
      expect(node.nodes).toHaveStringExpression(1, 'foo');
      expect(node.nodes).toHaveStringExpression(2, 'bar');
      expect(node.nodes).toHaveStringExpression(3, 'baz');
    });
    ...
    it('inserts a node at the end', () => {
      ...
      expect(node.nodes).toHaveStringExpression(0, 'foo');
      expect(node.nodes).toHaveStringExpression(1, 'bar');
      expect(node.nodes).toHaveStringExpression(2, 'baz');
      expect(node.nodes).toHaveStringExpression(3, 'qux');
    });
    ...
    it('inserts multiple nodes', () => {
      ...
      expect(node.nodes).toHaveStringExpression(1, 'bar');
      expect(node.nodes).toHaveStringExpression(3, 'qux');
      expect(node.nodes).toHaveStringExpression(4, 'qax');
      expect(node.nodes).toHaveStringExpression(5, 'qix');
      expect(node.nodes).toHaveStringExpression(6, 'baz');
    });
  ...
  describe('insertBefore', () => {
    ...
    it('inserts a node before the given element', () => {
      ...
      expect(node.nodes).toHaveLength(4);
      expect(node.nodes).toHaveStringExpression(0, 'foo');
      expect(node.nodes).toHaveStringExpression(1, 'qux');
      expect(node.nodes).toHaveStringExpression(2, 'bar');
      expect(node.nodes).toHaveStringExpression(3, 'baz');
    });
    ...
    it('inserts multiple nodes', () => {
      ...
      expect(node.nodes).toHaveStringExpression(0, 'foo');
      expect(node.nodes).toHaveStringExpression(1, 'qux');
      expect(node.nodes).toHaveStringExpression(2, 'qax');
      expect(node.nodes).toHaveStringExpression(3, 'qix');
      expect(node.nodes).toHaveStringExpression(4, 'bar');
      expect(node.nodes).toHaveStringExpression(5, 'baz');
    });
  ...
  describe('prepend', () => {
    ...
    it('inserts multiple nodes', () => {
      ...
      expect(node.nodes).toHaveLength(6);
      expect(node.nodes).toHaveStringExpression(0, 'qux');
      expect(node.nodes).toHaveStringExpression(1, 'qax');
      expect(node.nodes).toHaveStringExpression(2, 'qix');
      expect(node.nodes).toHaveStringExpression(3, 'foo');
      expect(node.nodes).toHaveStringExpression(4, 'bar');
      expect(node.nodes).toHaveStringExpression(5, 'baz');
    });
  ...
  describe('push', () => {
    ...
    it('returns itself', () => expect(node.push(new StringExpression({text: 'baz'}))).toBe(node));
  });
  ...
  describe('some', () => {
    ...
    it('returns true if the callback returns true for any element', () =>
      expect(node.some(element => (element as StringExpression).text.asPlain === 'bar')).toBe(true));
  });
  ...
  describe('first', () => {
    ...
    it('returns undefined for an empty interpolation', () =>
      expect(new ListExpression({separator: null, nodes: []}).first).toBeUndefined());
  });
  ...
  describe('last', () => {
    ...
    it('returns undefined for an empty interpolation', () =>
      expect(new ListExpression({separator: null, nodes: []}).last).toBeUndefined());
  });
    ...
    describe('with no overrides', () => {
      ...
      describe('has the same properties:', () => {
        it('nodes', () => {
          ...
          expect(clone.nodes).toHaveStringExpression(0, 'foo');
          expect(clone.nodes).toHaveStringExpression(1, 'bar');
        });
    ...
    describe('overrides', () => {
      describe('nodes', () => {
        it('defined', () => {
          ...
          expect(clone.nodes).toHaveStringExpression(0, 'zip');
        });
...
function testEachMutation(
  ...
  for (let i = 0; i < elements.length; i++) {
    ...
    expect(fn).toHaveBeenNthCalledWith(i + 1, expect.toHaveProperty('text', expect.toHaveProperty('asPlain', value)), index);
  }
