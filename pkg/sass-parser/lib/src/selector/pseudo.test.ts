...
describe('a pseudo selector', () => {
  ...
  describe('with a selector and an argument', () => {
    function describeNode(
      ...
      describe(description, () => {
        ...
        it('has an argument', () =>
          expect(node).toHaveInterpolation('argument', '2n of'));
    ...
    describeNode('parsed', () => parseSimpleSelector(':nth-child(2n of .foo)'));
  ...
  describe('with an interpolated name and argument', () => {
    function describeNode(
      ...
      describe(description, () => {
        ...
        it('has a name', () =>
          expect(node.pseudo).toHaveStringExpression(0, 'foo'));
  ...
  describe('with an interpolated argument and a selector', () => {
    function describeNode(
      ...
      describe(description, () => {
        ...
        it('has a name', () =>
          expect(node.pseudo).toHaveStringExpression(0, 'nth-child'));
  ...
  it('assigned new element', () => {
    ...
    node.isElement = true;
    expect(node.isClass).toBe(false);
    expect(node.isElement).toBe(false);
  });

  it('assigned new argument', () => {
    node = parseSimpleSelector(':foo(bar)') as PseudoSelector;
    node.argument = 'baz';
    expect(node).toHaveInterpolation('pseudo', 'baz');
  });
  ...
  describe('clone', () => {
    ...
    describe('with no overrides', () => {
      ...
      describe('has the same properties:', () => {
        ...
        it('argument', () =>
          expect(clone).toHaveInterpolation('pseudo', '2n of'));
    ...
    describe('overrides', () => {
      ...
      describe('argument', () => {
        ...
        it('undefined', () =>
          expect(original.clone({pseudo: undefined}).pseudo).toBeUndefined());
      });
